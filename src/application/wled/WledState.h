...
struct WledState {
    ...
    String toJson() const {
        String j = "{";
        j += "\"on\":"  + String(on ? "true" : "false") + ",";
        j += "\"bri\":" + String(brightness) + ",";
        j += "\"seg\":[{";
        j += "\"fx\":"  + String(effectIndex) + ",";
        j += "\"sx\":"  + String(speed) + ",";
        j += "\"ix\":"  + String(intensity) + ",";
        j += "\"col\":[[" + String(color.r) + "," +
                            String(color.g) + "," +
                            String(color.b) + "]]";
        j += "}]}";
        return j;
    ...
    // 
    String jsonPower()      const { return "{\"on\":" + String(on ? "true" : "false") + "}"; }
    String jsonBrightness() const { return "{\"bri\":" + String(brightness) + "}"; }
    String jsonEffect()     const { return "{\"seg\":[{\"fx\":" + String(effectIndex) + "}]}"; }
    String jsonSpeed()      const { return "{\"seg\":[{\"sx\":" + String(speed) + ",\"ix\":" + String(intensity) + "}]}"; }
    String jsonColor()      const {
        return "{\"seg\":[{\"col\":[[" +
               String(color.r) + "," +
               String(color.g) + "," +
               String(color.b) + "]]}]}";
