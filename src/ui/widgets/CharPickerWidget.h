...
class CharPickerWidget : public IScreen {
    public:
        ...
        CharPickerWidget(DisplayManager& display, const String& title, 
                         String& initial, std::function<void(const String&)> onDone)
                        : _display(display)
                        , _title(title)
                        ,_onDone(onDone)
                        ,_result(initial)
    ...
    private:
        ...
        String                             _title;
        std::function<void(const String&)> _onDone;
        String                             _result;
        int                                _charIdx  = 0;
