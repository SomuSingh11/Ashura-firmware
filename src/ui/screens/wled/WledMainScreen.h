...
class WledMainScreen : public IScreen {
    ...
    private:
        ...
        void _draw() {
            ...
            String devName = dev ? dev->name : "Unknown";
        ...
        String _itemValue(int idx) {
            const WledState& s = _wled.state();
            switch (idx) {
                case 0: return s.on ? "ON" : "OFF";
                case 1: return String(s.brightness);
                case 2: return _wled.effectName(s.effectIndex);
                case 3: return "R" + String(s.color.r) +
                            " G" + String(s.color.g) +
                            " B" + String(s.color.b);
                case 4: return String(s.speed);
                default: return "";
            }
        }
};